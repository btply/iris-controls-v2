#line 1 "/home/billy/Documents/Code/iris-controls-v2/src/services/MqttService.h"
...
class MqttService {
 ...
 private:
  ...
  rtos::Thread workerThread{osPriorityNormal, 6144, nullptr, "mqtt"};
  std::atomic<bool> running{false};
  std::atomic<bool> networkReady{false};
  std::atomic<bool> mqttConnectedCached{false};
